...
/** One live-rate provider for the whole app, so every page shares the cache. */
const getRate = createRateProvider();
/** Same origin: the sponsor routes live in this Next app. */
const relay = createRelayClient({ baseUrl: '' });
